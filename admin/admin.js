/* Full admin fix for GitHub Pages. Password: siongadmin. Publish fix removes cache-control/no-store CORS issue. */
...
async function saveToGithub(){
  ...
  try{
    ...
    /*
      GitHub Pages stability mode:
      This publishes text, promo boxes, WhatsApp/Facebook settings, nav, calculator and SEO.
      Actual image file upload is disabled to avoid browser GitHub API upload failures.
      To change real photos, replace image files manually inside the GitHub assets folder.
    */
    pendingImages = [];
